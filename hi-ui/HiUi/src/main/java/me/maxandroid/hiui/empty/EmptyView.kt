package me.maxandroid.hiui.empty
...
class EmptyView : LinearLayout {
    ...
    private var emptyTip: IconFontTextView
    ...
    constructor(context: Context, attributes: AttributeSet?, defStyle: Int) : super(
        ...
        emptyTip = findViewById(R.id.empty_tips)
    ...
    fun setHelpAction(@StringRes actionId: Int = R.string.if_detail, listener: OnClickListener) {
        emptyTip.setText(actionId)
        emptyTip.setOnClickListener(listener)
        emptyTip.visibility = if (actionId == -1) View.GONE else View.VISIBLE
    }
