 ...
 * <code>android:name</code> or {@link HiFragmentNavigator.Destination#setClassName(String)}.
 * <p>
...
//        ft.replace(mContainerId, frag);
    ...
    public static class Destination extends NavDestination {
         ...
         */
        @NonNull
        public final HiFragmentNavigator.Destination setClassName(@NonNull String className) {
    ...
    public static final class Extras implements Navigator.Extras {
        ...
        public static final class Builder {
             ...
             */
            @NonNull
            public HiFragmentNavigator.Extras.Builder addSharedElements(@NonNull Map<View, String> sharedElements) {
             ...
             */
            @NonNull
            public HiFragmentNavigator.Extras.Builder addSharedElement(@NonNull View sharedElement, @NonNull String name) {
             ...
             */
            @NonNull
            public HiFragmentNavigator.Extras build() {
                return new HiFragmentNavigator.Extras(mSharedElements);
            }
        }
    }
}
