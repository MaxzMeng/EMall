...
import me.maxandroid.hirouter.model.BottomBar;
import me.maxandroid.hirouter.model.Destination;
    ...
    public static void buildNavGraph(FragmentActivity activity, FragmentManager childFragmentManager, NavController controller, int containerId) {
        ...
        while (iterator.hasNext()) {
            ...
            if (destination.destType.equals("activity")) {
                ...
                HiFragmentNavigator navigator = provider.getNavigator(HiFragmentNavigator.class);
                HiFragmentNavigator.Destination node = navigator.createDestination();
                node.setId(destination.id);
